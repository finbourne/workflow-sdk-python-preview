...
class WorkersApi(object):
    ...
    def create_worker(self, create_worker_request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] CreateWorker: Endpoint For Creating a Worker  # noqa: E501
    ...
    def get_worker(self, scope, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetWorker: Endpoint for Retrieving a Worker  # noqa: E501
        ...
        :type code: str
        :param as_at: AsAt time of the worker
        :type as_at: datetime
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will

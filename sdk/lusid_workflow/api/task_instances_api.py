...
class TaskInstancesApi(object):
    ...
    def invoke_trigger(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] InvokeTrigger: Invoke a Task Instance Trigger.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.invoke_trigger(id, async_req=True)
        >>> result = thread.get()

        :param id: Id of the task instance to act upon (required)
        :type id: str
        :param trigger:
        :type trigger: str
        :param task_instance_scope: The scope of the task instance to retrieve from; 'default' if not provided.
        :type task_instance_scope: str
        :param transit_task_instance_request: The details of the request
        :type transit_task_instance_request: TransitTaskInstanceRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: TriggerInvocationResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.invoke_trigger_with_http_info(id, **kwargs)  # noqa: E501

    def invoke_trigger_with_http_info(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] InvokeTrigger: Invoke a Task Instance Trigger.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.invoke_trigger_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object, the HTTP status code, and the headers.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: (TriggerInvocationResponse, int, HTTPHeaderDict)
        """
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `invoke_trigger`")  # noqa: E501

        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['id']) > 40):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `invoke_trigger`, length must be less than or equal to `40`")  # noqa: E501
        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['id']) < 30):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `invoke_trigger`, length must be greater than or equal to `30`")  # noqa: E501
        if self.api_client.client_side_validation and 'id' in local_var_params and not re.search(r'^[a-zA-Z0-9\-]+$', local_var_params['id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `invoke_trigger`, must conform to the pattern `/^[a-zA-Z0-9\-]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('trigger' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `trigger` when calling `invoke_trigger`, length must be less than or equal to `150`")  # noqa: E501
        if self.api_client.client_side_validation and ('trigger' in local_var_params and  # noqa: E501
                                                        len(local_var_params['trigger']) < 5):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `trigger` when calling `invoke_trigger`, length must be greater than or equal to `5`")  # noqa: E501
        if self.api_client.client_side_validation and ('task_instance_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['task_instance_scope']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `task_instance_scope` when calling `invoke_trigger`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('task_instance_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['task_instance_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `task_instance_scope` when calling `invoke_trigger`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'task_instance_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['task_instance_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `task_instance_scope` when calling `invoke_trigger`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'transit_task_instance_request' in local_var_params:
            body_params = local_var_params['transit_task_instance_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        response_types_map = {
            200: "TriggerInvocationResponse",
            400: "LusidValidationProblemDetails",
            404: "str",
        }

        return self.api_client.call_api(
            '/api/taskinstances/{id}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

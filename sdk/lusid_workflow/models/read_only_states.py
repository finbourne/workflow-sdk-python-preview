...
class ReadOnlyStates(object):
    ...
    def __init__(self, state_type=None, selected_states=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param state_type:  The State Type (e.g. InitialState, AllStates, SelectedStates) (required)
        :type state_type: str
        :param selected_states:  Named states for which the field will be readonly - This field can only be populated if StateType = SelectedStates (required)
    ...
    def state_type(self):
        ...
        The State Type (e.g. InitialState, AllStates, SelectedStates)  # noqa: E501
    ...
    def selected_states(self, selected_states):
        ...
        :type selected_states: list[str]
        """
        if self.local_vars_configuration.client_side_validation and selected_states is None:  # noqa: E501
            raise ValueError("Invalid value for `selected_states`, must not be `None`")  # noqa: E501

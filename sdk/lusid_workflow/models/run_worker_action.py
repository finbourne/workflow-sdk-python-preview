...
class RunWorkerAction(object):
    ...
    def __init__(self, worker_id=None, worker_as_at=None, worker_parameters=None, worker_status_triggers=None, child_task_configurations=None, type=None, local_vars_configuration=None):  # noqa: E501

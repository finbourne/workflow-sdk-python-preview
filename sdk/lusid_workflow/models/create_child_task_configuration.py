...
class CreateChildTaskConfiguration(object):
    ...
    def __init__(self, task_definition_id=None, task_definition_as_at=None, initial_trigger=None, child_task_fields=None, local_vars_configuration=None):  # noqa: E501
